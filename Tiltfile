...
# Timoni bundle generation
local_resource(
  'timoni-build',
  'timoni bundle build -f timoni/bundle.cue -r timoni/runtime-{}.cue > /tmp/tilt-manifests.yaml'.format(runtime),
  deps=['timoni/'],
  labels=['infrastructure']
)

# Apply manifests generated by Timoni
k8s_yaml('/tmp/tilt-manifests.yaml', allow_duplicates=True)
