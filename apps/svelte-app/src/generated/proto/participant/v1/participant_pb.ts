...
export class CreateParticipantRequest extends Message<CreateParticipantRequest> {
  ...
  /**
   * @generated from field: optional string mental_illness = 9;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 9, name: "mental_illness", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ]);
...
export class Participant extends Message<Participant> {
  ...
  /**
   * @generated from field: optional string mental_illness = 11;
   */
  mentalIllness?: string;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 11, name: "mental_illness", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
