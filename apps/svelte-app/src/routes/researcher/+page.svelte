  ...
  onMount(async () => {
    try {
      ...
      if (participants.length > 0) {
        // Find Jun Kawasaki if exists, otherwise first one
...
<div class="analyzer-page">
  ...
  {:else}
    <div class="analyzer-content space-y-8">
      <!-- Participant Selector (Horizontal scroll on mobile) -->
      ...
      <!-- Overview Stats (Hidden on mobile to focus on specific analysis) -->
