...
import { Card, CardContent, CardHeader, CardTitle } from './researcher/ui/card'
import { Tabs, TabsContent, TabsList, TabsTrigger } from './researcher/ui/tabs'
import { Button } from './researcher/ui/button'
