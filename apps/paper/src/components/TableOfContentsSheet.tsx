    ...
    <>
      ...
      <div
        className={`
          ...
          w-[280px] md:w-full
          h-full md:h-auto
          max-h-full md:max-h-[calc(100vh-64px-env(safe-area-inset-top,0px)-32px)]
          overflow-hidden
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 md:p-5 border-b border-gray-200 dark:border-gray-700">
          ...
          {!isOpen && (
            <h3 className="text-[17px] font-semibold leading-[1.4] text-gray-900 dark:text-gray-100 tracking-[-0.01em] md:hidden">
              Table of Contents
            </h3>
          )}
          <button
            onClick={() => setIsOpen(false)}
            className="md:hidden p-1 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
            aria-label="Close"
          >
          ...
          <button
            onClick={() => setIsOpen(!isOpen)}
            className="hidden md:flex md:items-center md:justify-center md:w-full md:p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
            aria-label="Toggle Table of Contents"
          >
            <svg
              className={`w-5 h-5 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
        ...
        {/* Sheet Body */}
        {isOpen && (
          <div className="overflow-y-auto h-full md:max-h-[calc(100vh-64px-env(safe-area-inset-top,0px)-96px)] p-4 md:p-5">
