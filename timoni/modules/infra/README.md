...
A [timoni.sh](http://timoni.sh) module for deploying infra to Kubernetes clusters.
...
```shell
timoni -n default apply infra oci://<container-registry-url>
```
...
| `image: repository:`         | `string`                                | `envoyproxy/envoy` | Container image repository                                                                                                                   |
