-- Merkle DAG: recreate_views -> restore_dropped_views
-- 削除されたテーブルに依存していたビューを再作成

-- participant_summaryビューの再作成（participant_analysis_resultsを参照しないように修正）
...
SELECT
  ...
  -- Analysis statistics (participant_analysis_resultsが削除されたため、timeline_pointsから計算)
