...
import type { WordNode, WordLink, TimelineDataPoint, GapArea, CommonFeatures, DensityRegion, DuplicateCandidate } from './types'
...
function calculateCommonEmotionProfile(
  nearbyNodes: NonNullable<GapArea['nearbyNodes']>,
  emotionVectors: Record<string, number[]>
