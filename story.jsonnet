      ...
      key_pillars: [
        ...
        },
        {
          ...
          sub_processes: [
            ...
            'プロセスネットワーク最適化',
            'SOLID原則完全実装',
            'GraphQL + Apollo Clientアーキテクチャ実装',
            'シンプルな型安全API層の確立',
        ...
        },
        {
          ...
          sub_processes: [
            ...
            'インタラクティブな反応パターン分析UI',
            '科学的手法による霊性測定時系列理解深化',
            'GraphQL + Apollo Clientアーキテクチャへの完全移行',
            'Rust GraphQL Server (async-graphql)実装',
            'GraphQL Code Generatorによる型安全コード生成',
            'シンプルな型安全API層の実現',
        ...
        metadata: {
          ...
          merkle_root: 'GraphQL + Apollo Clientアーキテクチャ版 + Mentor RDF統合',
