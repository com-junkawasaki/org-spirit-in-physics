// Merkle DAG: graphql.service.api.health
// Vercel Serverless Function entry point for health check endpoint
// This file is the entry point for /api/health route

use vercel_runtime::{run, Body, Error, Request, Response, StatusCode};
use serde_json::json;
use graphql_service::get_allowed_origins;
