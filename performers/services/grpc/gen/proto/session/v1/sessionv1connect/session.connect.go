...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/spirit-in-physics/services/grpc/gen/proto/session/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// GetSessions RPC.
	SessionServiceGetSessionsProcedure = "/session.v1.SessionService/GetSessions"
...
func NewSessionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SessionServiceClient {
	...
	return &sessionServiceClient{
		getSessions: connect.NewClient[v1.GetSessionsRequest, v1.GetSessionsResponse](
			...
			connect.WithSchema(sessionServiceMethods.ByName("GetSessions")),
...
// GetSessions calls session.v1.SessionService.GetSessions.
func (c *sessionServiceClient) GetSessions(ctx context.Context, req *connect.Request[v1.GetSessionsRequest]) (*connect.Response[v1.GetSessionsResponse], error) {
...
func NewSessionServiceHandler(svc SessionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	sessionServiceMethods := v1.File_session_v1_session_proto.Services().ByName("SessionService").Methods()
	sessionServiceGetSessionsHandler := connect.NewUnaryHandler(
	...
	return "/session.v1.SessionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case SessionServiceGetSessionsProcedure:
			sessionServiceGetSessionsHandler.ServeHTTP(w, r)
...
func (UnimplementedSessionServiceHandler) GetSessions(context.Context, *connect.Request[v1.GetSessionsRequest]) (*connect.Response[v1.GetSessionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("session.v1.SessionService.GetSessions is not implemented"))
}
