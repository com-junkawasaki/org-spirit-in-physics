...
func NewImportHandler(queries *db.Queries, workflowClient *workflow.Client) *ImportHandler {
...
func (h *ImportHandler) ImportParticipants(
	...
	// Direct import using activities
...
func (h *ImportHandler) ImportEmotions(
	...
	// Import emotions for all participants found in the dataset
