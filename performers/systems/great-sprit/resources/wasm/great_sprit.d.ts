 ...
 */
export function load_emotion_data(observations_json: string): void;
/**
 * Load RDF data from GraphQL (called from JavaScript)
 */
export function load_rdf_data(triples_json: string): void;
/**
 * WebAssembly entry point for Bevy visualization
 */
export function start_bevy_app(canvas_id: string): void;
...
export interface InitOutput {
  ...
  readonly init: () => void;
  readonly load_emotion_data: (a: number, b: number) => [number, number];
  readonly start_bevy_app: (a: number, b: number) => [number, number];
  readonly load_rdf_data: (a: number, b: number) => [number, number];
  ...
  readonly wasm_bindgen__convert__closures_____invoke__hbde2a249a8b01a73: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__h650f5b7e3afb01d4: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h4250c05eaa7a5461: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h4f75672076e5a3df: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h777b3e21d1992eea: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h7fe67b7580bb92eb: (a: number, b: number, c: any, d: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h7fa68b182df6b1fe: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__hba9aac76b9fd5adf: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h96ded1bb6bc6f2dc: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__hd9644dadbb73cc58: (a: number, b: number) => void;
